...
public class TPMServerConfig {
	...
	public TPMServerConfig(String keyStorePath, String keyStorePwd, String keyPairEntry, String keyPairPwd,
			...
			String hashProvider, String symmAlg, String symmProvider, int symmKeySize, byte[] initializationVector) {
	...
	public CipherSuiteConfig getSymEncrypConfig() {
		return new CipherSuiteConfig(getHashAlg(), getHashProvider(), getSymmAlg(), getSymmProvider(), getSymmKeySize(), getIV());		
	}
